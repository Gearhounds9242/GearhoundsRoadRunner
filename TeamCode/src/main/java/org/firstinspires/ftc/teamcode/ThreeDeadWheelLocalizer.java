...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -2068.156636792272; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 1957.1851319940458; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -1583.1478465244338; // x position of the perpendicular encoder (in tick units)
    }
